...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "platform.discord": (
        ...
        # release; Hermes verifies and carries the fixed version directly.
        "PyNaCl==1.6.2",
        "davey==0.1.6",
        "brotlicffi==1.2.0.1",
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # CVE-2026-48710/54283 — keep lazy-install in sync with pyproject [web]
        "python-multipart==0.0.31",  # CVE-2026-53539 and later parser advisories; streaming uploads (NS-501)
    ),
    ...
    "tool.computer_use": (
        "mcp==1.28.1",  # CVE-2026-52870/52869/59950
        "starlette==1.3.1",  # CVE-2026-48710/54283 — keep in sync with pyproject [computer-use]
    ),
