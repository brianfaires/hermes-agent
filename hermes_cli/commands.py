...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("history", "Show conversation history", "Session",
               cli_only=True),
    CommandDef("hindsight-history", "Show reconstructed Hindsight retain and recall activity", "Session",
               gateway_only=True, aliases=("memory-history",),
               args_hint="[--retain-only|--recall-only] [--turns N]"),
