...
published as redacted, atomically committed files under the shared Hermes root.
Cron core only publishes; an opt-in bundled plugin owns consumption and durable
acknowledgement.
"""
...
def _publish_cross_profile_event(event: str, payload: Dict[str, Any]) -> None:
    """Best-effort atomic event-file publication for cross-profile observers."""
