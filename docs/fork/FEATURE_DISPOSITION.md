...
RETAINED-FEATURE INTEGRATION UPDATE (2026-09-06). Brian authorized all five reviewed candidates; they are integrated in release-owner task `t_ddd2e9dc` on doctor baseline `9ccb53e3d15730fcae88b086ea954dfc377574aa`. FC-11/37/41/42/44 are implemented candidates; FC-43 is explicitly SUPERSEDED as described below. This is source integration, not whole-rebase completion, hosted-CI qualification, deployment or feature activation. Earlier FC-16/22/28B/36 approvals and all other feature decisions remain unchanged. Exact commits, trees, equivalence and focused test results are in the parent task’s `integration-evidence.json` and `integration-result.json`.
