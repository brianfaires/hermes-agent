...
RELEASE PREPARATION UPDATE (2026-09-06). Brian explicitly approved implementation and qualified release of FC-16, FC-22, FC-28B and FC-36; this supersedes their historical freezes below. FC-37 and FC-11/43–44 remain deferred. FC-42 is now an independently reviewed, undeployed implementation candidate in task `t_71fd77a3`; integration and activation remain outstanding. FC-41 was subsequently resolved by Brian (see `BRIAN_UAT.md`) and now carries an implemented, undeployed candidate. The protected inventory remains immutable; current main/staging reconciliation is recorded separately below. Exact candidate/review/test status lives in the external `evidence-20260906/handoff.json` and current task handoffs, not in historical review claims.
...
| FC-42 | Private `/log` journal capture and nightly batch | I141, I153 | `REWRITE` | Brian authorized private capture, one isolated midnight batch, default raw retention and intentional finalized-entry-only Hindsight ingestion. Independently reviewed candidate in `t_71fd77a3`, based on reviewed FC-41 at `10813a6f2e230cf016a8a2ebd24125972edf10a3`. Disabled profile plugin; generic private command dispatch seam; durable batch/archive/receipts; explicit uncertainty reconciliation. One P1 cold-TUI history finding closed with fixture regression and targeted independent review. | NOT deployed; hosted CI and live activation remain release-owned. Exact SHA/tests/review receipts in the task handoff. Activation packet: `plugins/private_journal/installation/`; Ang `t_ddd2e9dc` owns integration/release, Ops configuration. Retention deletion interval undecided and destructive cleanup off; no FC-43 policy port. |
