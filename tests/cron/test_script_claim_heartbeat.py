...
def test_lost_fire_claim_stops_stale_delivery(monkeypatch):
    ...
    monkeypatch.setattr(scheduler, "mark_execution_running", lambda execution_id, **_kw: None)
...
def test_terminal_owner_cas_failure_marks_ledger_ownership_lost(monkeypatch):
    ...
    monkeypatch.setattr(scheduler, "mark_execution_running", lambda *_args, **_kw: None)
    monkeypatch.setattr(
        scheduler,
        "run_job",
