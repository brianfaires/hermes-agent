...
KANBAN_GUIDANCE = (
    ...
    "When `$HERMES_KANBAN_OWNER_INSTRUCTION` is set, do not mutate the original task. "
    "Finish only via `kanban_comment(task_id=$HERMES_KANBAN_TASK, body=..., "
    "owner_instruction_disposition=completed|refused)`.\n"
    "\n"
    "## Lifecycle\n"
    "\n"
