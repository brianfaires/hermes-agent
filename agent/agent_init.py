...
def init_agent(
    ...
    # decides at spawn time whether this process is scoped to a single task by
    # setting HERMES_KANBAN_TASK. Do not key this off kanban_show availability:
    # orchestrator profiles can explicitly enable the kanban toolset outside a
    # worker run, and those sessions should keep the board tools without
    # receiving worker-only lifecycle instructions.
